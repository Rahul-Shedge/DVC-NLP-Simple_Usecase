...
def main(config_path, params_path):
    ...
    model_path = os.path.join(model_dir_path,artifacts["MODEL"])
    ...
    logging.info(f"X input matrix size : {x.shape}")
    logging.info(f"Y input matrix size or labels size: {labels.shape}")
